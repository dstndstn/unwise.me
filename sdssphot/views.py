...
class SdssPhotRaDecBoxSearchForm(RaDecBoxSearchForm, SdssPhotForm):
    pass
...
def fields_near_fits(req):
    return conesearch_results(req, fields_fits_table=True)

def fields_box_fits(req):
    return boxsearch_results(req, fields_fits_table=True)
